...
class Controller(Component):
    ...
    def a(self):
        ...
        self.parent.transform.layer += 2
        self.parent.speed =20

        surface = self.parent.sprite_renderer.get_surface().convert_alpha()
        surface.fill((255,0,0,100))
        self.parent.sprite_renderer.set_surface(surface)
        self.parent.collider.active = False
            
        self.engine.scheduler.schedule_event(0.5, self.b)
    ...
    def b(self):
        ...
        self.parent.collider.active = True
